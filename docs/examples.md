...
The short convolution all-gathers one `W - 1` token tail per subsequence and routes its
...
kernels on SM100, all-gathers them, and folds each subsequence's predecessors or successors before
