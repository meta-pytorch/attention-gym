...
# Shared SM100 tcgen05 UMMA helpers (extracted; see sm100_umma.py).
from attn_gym.linear.kda.sm100_umma import (
    Tcgen05SmemDescriptor,
    _resolve_chunk_route,
    ...
    smem_load_bf16x8_sw128,
    smem_load_f32x4_sw128,
