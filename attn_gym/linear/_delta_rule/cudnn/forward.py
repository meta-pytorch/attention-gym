...
def chunk_delta_rule_fwd_cudnn(
    q: torch.Tensor,
    k: torch.Tensor,
    value: torch.Tensor,
    gate: torch.Tensor,
...
def chunk_delta_rule_fwd_cudnn_unsplit_with_initial_state(
    q: torch.Tensor,
    k: torch.Tensor,
    value: torch.Tensor,
    gate: torch.Tensor,
...
def chunk_delta_rule_fwd_cudnn_unsplit_with_state(
    q: torch.Tensor,
    k: torch.Tensor,
    value: torch.Tensor,
    gate: torch.Tensor,
...
__all__ = [
    ...
    "chunk_delta_rule_fwd_cudnn_unsplit_with_initial_state",
