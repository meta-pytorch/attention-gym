...
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.mma import mma_step, mma_ts_step
...
class KdaRecomputeOp:
    """Compile and launch one static cudnn KDA recompute configuration."""
...
def _compile_kda_recompute_prologue(
    ...
    return compile_tvm_ffi(
        ...
        cutlass.Int32(checkpoint_every_n_tokens),
        name=(
            f"kda_cudnn_recompute_prologue_{io_dtype.__name__.lower()}"
