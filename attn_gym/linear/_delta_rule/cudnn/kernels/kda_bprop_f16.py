...
from attn_gym.linear._delta_rule.cudnn.kernels.common.host import checkpoint_capacity_bound, get_dtype

from attn_gym.linear._delta_rule.cudnn.kernels.common.thd import (
    TENSOR_MAP_QWORDS,
    emit_checkpoint_seq_descs,
    emit_seq_descs,
    emit_seq_load_descs,
)
from attn_gym.linear._delta_rule.cudnn.kernels.common.tvm_ffi import (
...
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.barrier import (
    advance,
    MBarrier,
    PipelineState,
    Producer,
)
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.handles import (
    MmaDesc,
    SmemTile,
    smem_data_ptr,
    tma_slice_runtime_desc,
)
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.mma import mma_ss, mma_step, mma_ts_step
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.swizzle import (
    swizzle_box_offset_32b,
    swizzle_box_offset_128b,
)
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.tma import tma_load_tile, tma_store_commit, tma_store_tile, tma_store_wait, tma_tensormap_acquire
from attn_gym.linear._delta_rule.cudnn.kernels.tile_dsl.pointwise import (
    beta_residual_f16x2,
    f16x2_to_f32,
    fadd2,
    ffma2,
...
class KdaBpropOp:
    """Compile and launch one static cudnn KDA backward configuration."""
    ...
    def get_name(self) -> str:
        ...
        return (
            f"kda_cudnn_bprop_{cfg.io_dtype.__name__.lower()}_h{cfg.n_heads_out}"
...
def _compile_kda_bprop_prologue(
    ...
    return compile_tvm_ffi(
        ...
        make_workspace_signature(workspace_words),
        name=(
            f"kda_cudnn_bprop_prologue_{io_dtype.__name__.lower()}"
