...
"""Shared work-table and scratch allocation for cuDNN forward and backward."""
...
class CudnnSchedule(NamedTuple):
...
def prepare_cudnn_schedule(
    ...
    *,
    ...
    """Select geometry and allocate every host-owned cuDNN scheduling buffer."""
    if counter_count < 1:
...
__all__ = ["CudnnSchedule", "prepare_cudnn_schedule"]
