    ...
    *,
    ...
    Args:
        ...
        initial_state: Initial recurrent state shaped ``[N, H, V, K]`` in the recurrence compute
            dtype or BF16, where ``N`` is the number of logical sequences. BF16 state is promoted
            to the compute dtype for recurrence math.
...
def recurrent_gdn(
    ...
    *,
    ...
    inputs use FP32 recurrence math. State may use BF16 storage and is promoted for recurrence
    math.
