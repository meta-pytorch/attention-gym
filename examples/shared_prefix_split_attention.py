...
from attn_gym.utils import flex_attention_lse_to_merge_lse, merge_attention
...
def split_prefix_response_attention(q, k, v, prefix_slice: slice, response_slice: slice):
    ...
    response_out, _ = merge_attention(
        response_prefix_out,
        flex_attention_lse_to_merge_lse(response_prefix_aux.lse),
        response_self_out,
        flex_attention_lse_to_merge_lse(response_self_aux.lse),
    )
