"""Pointwise validation for cuDNN shared-memory layout helpers."""
...
pytestmark = pytest.mark.skipif(
    ...
    reason="the cuDNN SMEM layout test requires SM100 or SM103",
)
...
def compile_swizzled_offsets():
    ...
    return compile_tvm_ffi(
        ...
        name="cudnn_swizzle_box_offset_test",
    )
