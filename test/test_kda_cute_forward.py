...
def test_chunk_kda_state_indices_matches_pytorch():
    ...
    expected_output, expected_state = naive_chunk_kda_from_cumulative(
        q.float(),
        k.float(),
        v.float(),
        cumulative_gate,
    ...
    output, final_state = chunk_kda(
        q, k, v, cumulative_gate, beta, state_cache, state_indices=state_indices
    )
    assert expected_state is not None and final_state is None
