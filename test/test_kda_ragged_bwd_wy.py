...
def _run(inputs: StageInputs, metadata):
    return chunk_kda_bwd_wy_dqkg(*inputs, metadata, scale=128**-0.5, fastmath=False)
...
def test_ragged_wy_cuda_graph_replay():
    ...
    def operation(*args):
        *stage_tensors, offsets = args
        ...
        return chunk_kda_bwd_wy_dqkg(*stage_tensors, metadata, scale=128**-0.5, fastmath=False)
