...
def test_hopper_bc16_rebase_matches_reference_at_lower_bound_five(
    ...
    # Low-precision residual/state-cotangent tapes make terminal dK cancellation-sensitive.
    # Keep these failing seeds and check both paths against FP64 using max/RMS envelopes.
